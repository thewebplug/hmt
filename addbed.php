  ...
  <div class="col-md-12">
    ...
    <form action="validation.php" method="post">
      ...
      <option value="Admin">O+</option>
        ...
        <div class="form-group">
        <label>&nbsp;</label>
      <input type="submit" name="addorremove" value="Add or Remove" class="btn btn-primary">
      </div>


      <div class="form-group">
        <label>Bed Number</label>
      <input type="text" name="bednumber" placeholder="Bed Number" class="form-control" required"> 
      </div>
      ...
      <input type="text" name="description" placeholder="Description" class="form-control" required> 
        ...
        <div class="form-group">
        <label>&nbsp;</label>
      <input type="submit" name="submit" value="Add Bed" class="btn btn-primary">
      </div>
      </form>
      </div>
