...
<div class="row">
  <div class="col-md-12">
    <h2 style="font-weight: bold; color: #688BE8;">ACCOUNTANT REGISTRATION PAGE</h2>
    <p style="font-weight: bold; color: #688BE8; font-size: 25px;">Insert the details of the new Accountant you wish to register</p>

    <form action="accountantval.php" method="post">
      ...
      <input type="text" name="middlename" placeholder="Middle Name" class="form-control" required> 
       ...
       <div class="form-group">
        <label>Accountant Reg Number</label>
      <input type="text" name="accregnumber" placeholder="Accountant Reg Number" class="form-control" required> 
      </div>
 ...
 <div class="form-group">
      ...
      <input type="text" name="address" placeholder="Home Adress" class="form-control" required> 
      </div>
