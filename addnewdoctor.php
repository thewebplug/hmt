...
<div class="row">
  <div class="col-md-12">
    <h2 style="font-weight: bolder; color: #688BE8;">ADD NEW DOCTOR TO THE HMT DATA BASE</h2>
    ...
    <form action="adddoc.php" method="post">
      ...
      <input type="text" name="middlename" placeholder="Middle Name" class="form-control" required> 
       ...
       <div class="form-group">
        <label>Doctor Reg Number</label>
      <input type="text" name="docregnumber" placeholder="Doctor Reg Number" class="form-control" required> 
      </div>
 ...
 <div class="form-group">
      ...
      <input type="text" name="patientname" placeholder="username" class="form-control" required> 
      </div>
