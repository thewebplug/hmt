...
<div class="row">
  <div class="col-md-12">
    <h2 style="font-weight: bold; color: #688BE8;">LAB STAFF REGISTRATION</h2>
   <p style="font-weight: bold; color: #688BE8; font-size: 25px;">Insert the details of the new Lab Staff you wish to register</p>

    <form action="labstaffval.php" method="post">
      ...
      <div class="form-group">
        <label>Lab Staff Reg Number</label>
      <input type="text" name="labstaffregnumber" placeholder="Labstaff Reg Number" class="form-control" required> 
      </div>
