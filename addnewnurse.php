...
<div class="row">
  <div class="col-md-12">
    <h2 style="font-weight: bolder; color: #688BE8;">NURSE REGISTRATION</h2>
   <p style="font-weight: bold; color: #688BE8; font-size: 25px;">Insert the details of the new Nurse you wish to register</p>

    <form action="nurseval.php" method="post">
      ...
      <div class="form-group">
        <label>Nurse Reg Number</label>
      <input type="text" name="nurseregnumber" placeholder="Nurse Reg Number" class="form-control" required> 
      </div>
 ...
 <div class="form-group">
      ...
      <option value="Admin">Heart</option>
      <option value="Admin">ENT</option>
