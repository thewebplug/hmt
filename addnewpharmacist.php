...
<div class="row">
  <div class="col-md-12">
    <h2 style="font-weight: bold; color: #688BE8;">PHARMACIST</h2>
   <p style="font-weight: bold; color: #688BE8; font-size: 25px;">Insert the details of the new Pharmacist you wish to register</p>

    <form action="pharmacistval.php" method="post">
      ...
      <input type="text" name="phregnumber" placeholder="Doctor Reg Number" class="form-control" required> 
      </div>
