...
<div class="row">
  <div class="col-md-12">
    <h2 style="font-weight: bold; color: #688BE8;">SUPPPORT STAFF</h2>
   <p style="font-weight: bold; color: #688BE8; font-size: 25px;">Insert the details of the new Support Staff you wish to register</p>

    <form action="supportstaffval.php" method="post">
      ...
      <div class="form-group">
        <label>Support Staff Reg Number</label>
      <input type="text" name="supportstaffregnumber" placeholder="Supportstaff Reg Number" class="form-control" required> 
      </div>
