...
<div class="row">
  <div class="col-md-12">
    <h2 style="font-weight: bolder; color: #688BE8;">ADD NEW DRIVER REG NUMBER TO THE HMT DATA BASE</h2>

    <form action="driverregnumval.php" method="post">

        <div class="form-group">
        <label>Add New Driver Reg Number</label>
