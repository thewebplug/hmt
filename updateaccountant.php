...
<center>
	...
	<form action="" method="POST">
		...
		<input type="text" name="accregnumber" placeholder="Enter new Accountant Registration Number"><br>
...
if (isset($_POST['update'])) 
{
	...
	$query = "UPDATE `accountanttable` SET lastname='$_POST[lastname]',middlename='$_POST[middlename]',accregnumber='$_POST[accregnumber]',gender='$_POST[gender]',dob='$_POST[dob]',bloodgroup='$_POST[bloodgroup]',homeaddress='$_POST[homeaddress]',city='$_POST[city]',state='$_POST[state]',country='$_POST[country]',mobilenumber='$_POST[mobilenumber]',email='$_POST[email]',username='$_POST[username]',password='$_POST[password]' where firstname='$_POST[firstname]' ";
