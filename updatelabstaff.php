...
<body>
<center>
	<h1> Update Lab Staff Data Into Database</h1>
	...
	<form action="" method="POST">
		...
		<input type="text" name="labstaffregnum" placeholder="Enter new labstaffregnum"><br>
...
if (isset($_POST['update'])) 
{
	...
	$query = "UPDATE `labsatfftable` SET lastname='$_POST[lastname]',middlename='$_POST[middlename]',labstaffregnum='$_POST[labstaffregnum]',gender='$_POST[gender]',dob='$_POST[dob]',bloodgroup='$_POST[bloodgroup]',specialization='$_POST[specialization]',homeaddress='$_POST[homeaddress]',city='$_POST[city]',state='$_POST[state]',country='$_POST[country]',mobilenumber='$_POST[mobilenumber]',email='$_POST[email]',username='$_POST[username]',password='$_POST[password]' where firstname='$_POST[firstname]' ";
