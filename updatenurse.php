...
<center>
	...
	<form action="" method="POST">
		...
		<input type="text" name="nurseregnum" placeholder="Enter new NurseRegNum"><br>
...
if (isset($_POST['update'])) 
{
	...
	$query = "UPDATE `addnursetable` SET lastname='$_POST[lastname]',middlename='$_POST[middlename]',nurseregnum='$_POST[nurseregnum]',gender='$_POST[gender]',dob='$_POST[dob]',bloodgroup='$_POST[bloodgroup]',department='$_POST[department]',homeadress='$_POST[homeadress]',city='$_POST[city]',state='$_POST[state]',country='$_POST[country]',mobilenumber='$_POST[mobilenumber]',email='$_POST[email]',username='$_POST[username]',password='$_POST[password]' where firstname='$_POST[firstname]' ";
