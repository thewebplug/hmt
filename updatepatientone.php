...
<center>
	...
	<form action="" method="POST">
		...
		<input type="text" name="patientregnum" placeholder="Enter new patientregnum"><br>
		...
		<input type="text" name="homeadress" placeholder="Enter new homeaddress"><br>
...
if (isset($_POST['update'])) 
{
	...
	$query = "UPDATE `patienttable` SET lastname='$_POST[lastname]',middlename='$_POST[middlename]',patientregnum='$_POST[patientregnum]',gender='$_POST[gender]',dob='$_POST[dob]',bloodgroup='$_POST[bloodgroup]',homeadress='$_POST[homeadress]',city='$_POST[city]',state='$_POST[state]',country='$_POST[country]',mobilenumber='$_POST[mobilenumber]',email='$_POST[email]',username='$_POST[username]',password='$_POST[password]' where firstname='$_POST[firstname]' ";
