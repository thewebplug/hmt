...
<body>
<center>
	<h1>	Update Pharmacist Data Into Database</h1>
	...
	<form action="" method="POST">
		...
		<input type="text" name="pharmregnum" placeholder="Enter new PharmacistREgNumber"><br>
...
if (isset($_POST['update'])) 
{
	...
	$query = "UPDATE `pharmacisttable` SET lastname='$_POST[lastname]',middlename='$_POST[middlename]',pharmregnum='$_POST[pharmregnum]',gender='$_POST[gender]',dob='$_POST[dob]',bloodgroup='$_POST[bloodgroup]',homeadress='$_POST[homeadress]',city='$_POST[city]',state='$_POST[state]',country='$_POST[country]',mobilenumber='$_POST[mobilenumber]',email='$_POST[email]',username='$_POST[username]',password='$_POST[password]' where firstname='$_POST[firstname]' ";
