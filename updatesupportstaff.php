...
<center>
	...
	<form action="" method="POST">
		...
		<input type="text" name="supportstaffregnum" placeholder="Enter new supportstaffregnum"><br>
...
if (isset($_POST['update'])) 
{
	...
	$query = "UPDATE `supportstafftable` SET lastname='$_POST[lastname]',middlename='$_POST[middlename]',supportstaffregnum='$_POST[supportstaffregnum]',gender='$_POST[gender]',dob='$_POST[dob]',bloodgroup='$_POST[bloodgroup]',homeaddress='$_POST[homeaddress]',city='$_POST[city]',state='$_POST[state]',country='$_POST[country]',mobilenumber='$_POST[mobilenumber]',email='$_POST[email]',username='$_POST[username]',password='$_POST[password]' where firstname='$_POST[firstname]' ";
